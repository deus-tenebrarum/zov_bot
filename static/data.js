...
const LOCATION_RU_TO_EN = {
  'Нью-Йорк':'New York','Токио':'Tokyo','Париж':'Paris','Лондон':'London','Дубай':'Dubai','Сингапур':'Singapore','Гонконг':'Hong Kong','Сидней':'Sydney','Рим':'Rome','Барселона':'Barcelona','Амстердам':'Amsterdam','Берлин':'Berlin','Москва':'Moscow','Стамбул':'Istanbul','Сеул':'Seoul','Лос-Анджелес':'Los Angeles','Мумбаи':'Mumbai','Каир':'Cairo','Буэнос-Айрес':'Buenos Aires','Кейптаун':'Cape Town','Прага':'Prague','Краков':'Krakow','Лиссабон':'Lisbon','Киев':'Kyiv','Тбилиси':'Tbilisi','Ереван':'Yerevan','Рейкьявик':'Reykjavik','Хельсинки':'Helsinki','Осака':'Osaka','Киото':'Kyoto','Хошимин':'Ho Chi Minh City','Бангкок':'Bangkok','Куала-Лумпур':'Kuala Lumpur','Дакка':'Dhaka','Лахор':'Lahore','Дакар':'Dakar','Абиджан':'Abidjan','Найроби':'Nairobi','Аккра':'Accra','Лима':'Lima','Богота':'Bogotá','Кито':'Quito','Гавана':'Havana','Кингстон':'Kingston','Веллингтон':'Wellington','Халльстат':'Hallstatt','Гитхорн':'Giethoorn','Бибери':'Bibury','Попрад':'Poprad','Сигишоара':'Sighișoara','Оймякон':'Oymyakon','Кижи':'Kizhi','Суздаль':'Suzdal','Гореме':'Göreme','Ширакава-го':'Shirakawa-go','Ханой':'Hanoi','Луангпрабанг':'Luang Prabang','Сием Рип':'Siem Reap','Убуд':'Ubud','Дарджилинг':'Darjeeling','Лех':'Leh','Петра':'Petra','Марракеш':'Marrakesh','Фес':'Fes','Занзибар':'Zanzibar','Виктория-Фолс':'Victoria Falls','Виндхук':'Windhoek','Кигали':'Kigali','Аддис-Абеба':'Addis Ababa','Монровия':'Monrovia','Фритаун':'Freetown','Бамако':'Bamako','Ниамей':'Niamey','Нуакшот':'Nouakchott','Уагадугу':'Ouagadougou','Котону':'Cotonou','Ломе':'Lomé','Порт-о-Пренс':'Port-au-Prince','Сан-Хосе':'San José','Панама':'Panama City','Тегусигальпа':'Tegucigalpa','Манагуа':'Managua','Сан-Сальвадор':'San Salvador','Гватемала':'Guatemala City','Белиз':'Belize City','Асунсьон':'Asunción','Монтевидео':'Montevideo','Сантьяго':'Santiago','Ла-Пас':'La Paz','Каракас':'Caracas','Сукре':'Sucre','Копенгаген':'Copenhagen','Осло':'Oslo','Стокгольм':'Stockholm','Таллин':'Tallinn','Рига':'Riga','Вильнюс':'Vilnius','Минск':'Minsk','Кишинёв':'Chișinău','Тирана':'Tirana','Скопье':'Skopje','Сараево':'Sarajevo','Загреб':'Zagreb','Любляна':'Ljubljana','Белград':'Belgrade','София':'Sofia','Бухарест':'Bucharest','Будапешт':'Budapest','Вена':'Vienna','Цюрих':'Zurich','Женева':'Geneva','Брюссель':'Brussels','Дублин':'Dublin','Эдинбург':'Edinburgh','Глазго':'Glasgow','Манчестер':'Manchester','Ливерпуль':'Liverpool','Милан':'Milan','Венеция':'Venice','Флоренция':'Florence','Неаполь':'Naples','Мадрид':'Madrid','Валенсия':'Valencia','Севилья':'Seville','Афины':'Athens','Санторини':'Santorini','Тель-Авив':'Tel Aviv','Иерусалим':'Jerusalem','Доха':'Doha','Маскат':'Muscat','Баку':'Baku','Алматы':'Almaty','Ташкент':'Tashkent','Самарканд':'Samarkand','Бишкек':'Bishkek','Душанбе':'Dushanbe','Ашхабад':'Ashgabat','Улан-Батор':'Ulaanbaatar','Пекин':'Beijing','Шанхай':'Shanghai','Гуанчжоу':'Guangzhou','Чэнду':'Chengdu','Сиань':'Xi\'an','Лхаса':'Lhasa','Тайбэй':'Taipei','Манила':'Manila','Джакарта':'Jakarta','Янгон':'Yangon','Коломбо':'Colombo','Катманду':'Kathmandu','Тхимпху':'Thimphu','Порт-Луи':'Port Louis','Антананариву':'Antananarivo','Лусака':'Lusaka','Лилонгве':'Lilongwe','Мапуту':'Maputo','Хараре':'Harare','Габороне':'Gaborone','Мбабане':'Mbabane','Масеру':'Maseru','Нуук':'Nuuk','Ушуая':'Ushuaia','Куско':'Cusco','Сальвадор':'Salvador','Форталеза':'Fortaleza','Ресифи':'Recife','Белу-Оризонти':'Belo Horizonte','Канкун':'Cancún','Оахака':'Oaxaca','Гуанахуато':'Guanajuato','Сан-Мигель-де-Альенде':'San Miguel de Allende','Торонто':'Toronto','Ванкувер':'Vancouver','Монреаль':'Montreal','Квебек':'Quebec City','Калгари':'Calgary','Мельбурн':'Melbourne','Брисбен':'Brisbane','Перт':'Perth','Аделаида':'Adelaide','Окленд':'Auckland','Крайстчерч':'Christchurch','Паго-Паго':'Pago Pago','Сува':'Suva','Порт-Морсби':'Port Moresby','Торсхавн':'Tórshavn','Сент-Луис':'Saint-Louis','Королева':'Queenstown','Озеро Титикака':'Lake Titicaca','Патагония':'Patagonia','Кусоко':'Cusco','Апиа':'Apia','Касабланка':'Casablanca','Танжер':'Tangier','Шефшауэн':'Chefchaouen','Булавайо':'Bulawayo','Мутаре':'Mutare','Дебрецен':'Debrecen','Мишкольц':'Miskolc','Сегед':'Szeged','Печ':'Pécs','Сент-Питер-Порт':'St Peter Port','Сент-Джонс':'St John\'s','Денвер':'Denver','Свакопмунд':'Swakopmund','Фергана':'Fergana','Мекка':'Mecca','Медина':'Medina'
};
function getLocationDisplayName(name) {
  ...
  return (lang === 'en' && LOCATION_RU_TO_EN[name]) ? LOCATION_RU_TO_EN[name] : name;
}
...
if (typeof window !== 'undefined') {
  ...
  window.LOCATION_RU_TO_EN = LOCATION_RU_TO_EN;
